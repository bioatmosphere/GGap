...
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -o ../logs/wsb_16to64_%j.out
#SBATCH -e ../logs/wsb_16to64_%j.err

unset SLURM_EXPORT_ENV

# Weak Scaling B: 16-64 Nodes (128-512 GPUs)
# 100 sites/GPU, grid_height=10, block=10x10/rank

echo "========================================"
echo "Weak Scaling B: 16-64 Nodes (128-512 GPUs)"
echo "========================================"
