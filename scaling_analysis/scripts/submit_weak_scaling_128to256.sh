#!/bin/bash
#SBATCH -A lrn088
#SBATCH -J ws_128to256
#SBATCH -N 256
#SBATCH -t 12:00:00
#SBATCH -p batch
#SBATCH -o ../logs/ws_128to256_%j.out
#SBATCH -e ../logs/ws_128to256_%j.err

unset SLURM_EXPORT_ENV

# Weak Scaling: 128-256 Nodes (1024-2048 GPUs)

echo "========================================"
echo "Weak Scaling: 128-256 Nodes (1024-2048 GPUs)"
echo "========================================"
