...
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -o ../logs/ssb_64_%j.out
#SBATCH -e ../logs/ssb_64_%j.err

unset SLURM_EXPORT_ENV

# Strong Scaling B: 64 Nodes (512 GPUs)
# Fixed 2048 sites, 200 gaps, 500 trees
# 4 sites/GPU

echo "========================================"
echo "Strong Scaling B: 64 Nodes (512 GPUs)"
echo "========================================"
...
echo "  Ticks: $TICKS"
echo "  Sites/GPU: $((TOTAL_SITES / 512))"
echo ""
