...
Fixed problem size (512 sites), increase GPU count.
Each rank gets fewer sites as GPUs increase.

Setup: grid_height=4, width=128, total=512 sites
...
Usage:
    srun -N1 -n8 --gpus-per-node=8 python -u test_strong_scaling.py --total-sites 512
    srun -N16 -n128 --gpus-per-node=8 python -u test_strong_scaling.py --total-sites 512
"""
