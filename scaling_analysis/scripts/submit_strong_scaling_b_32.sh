...
#SBATCH -t 02:00:00
#SBATCH -p batch
#SBATCH -o ../logs/ssb_32_%j.out
#SBATCH -e ../logs/ssb_32_%j.err

unset SLURM_EXPORT_ENV

# Strong Scaling B: 32 Nodes (256 GPUs)
# Fixed 2048 sites, 200 gaps, 500 trees
# 8 sites/GPU

echo "========================================"
echo "Strong Scaling B: 32 Nodes (256 GPUs)"
echo "========================================"
...
echo "  Ticks: $TICKS"
echo "  Sites/GPU: $((TOTAL_SITES / 256))"
echo ""
