...
# Make the GGap `gap` package importable from a clean clone (tn_example -> SC2026 -> GGap root).
...
def main():
    ...
    parser.add_argument("--snapshot_dir", type=str,
                       default=os.path.join(script_dir, "results", "snapshots"),
                       help="Directory containing .npz snapshot files (default: ./results/snapshots)")
    parser.add_argument("--metadata_dir", type=str,
                       default=os.path.join(script_dir, "results"),
                       help="Directory containing rank_NNN_sites.pkl files (default: ./results)")
    parser.add_argument("--output_dir", type=str,
                       default=os.path.join(script_dir, "results", "species"),
                       help="Output directory for species_data.csv files (default: ./results/species)")
