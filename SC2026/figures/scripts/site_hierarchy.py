...
globe_path = os.path.join(assets_dir, 'globe.png')
...
conus_path = os.path.join(assets_dir, 'conus_nldas2_forest_fraction_notitle.png')
...
site_inset_path = os.path.join(assets_dir, 'site_inset.png')
