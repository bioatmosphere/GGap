...
SURFDATA = str(SCRIPT_DIR / "../assets/surfdata_0.125nldas2_hist_2000_78pfts_c240908.nc")
SITES_DIR = str(SCRIPT_DIR / "../../conus_simulation/results/10sites")
OUTPUT_MAP = str(SCRIPT_DIR / "../figs/conus_10sites_with_bars.png")
TARGET_YEAR = 1000
...
def read_size_dist(site_num):
    path = f"{SITES_DIR}/site_{site_num:04d}/species_data.csv"
    counts = np.zeros(6)
