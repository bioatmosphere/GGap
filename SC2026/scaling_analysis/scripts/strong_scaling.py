...
def main():
    ...
    parser.add_argument('--total-sites', type=int, default=2048,
                       help='Fixed total sites (default: 2048)')
    parser.add_argument('--grid-height', type=int, default=4,
                       help='Grid height (default: 4)')
    parser.add_argument('--num-gaps', type=int, default=200,
                       help='Gaps per site (default: 200)')
    parser.add_argument('--maxtrees', type=int, default=500,
                       help='Max trees per gap (default: 500)')
